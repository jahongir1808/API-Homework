...
function getCardUsers({
	...
	return `
		<div class='user-card d-flex flex-column gap-3'>
			...
			<div class="user-btn">
				<a class='user_btn-todos' onclick='saveId(${id})' href="todos.html">User todos</a>
				<a class='user_btn-post' onclick='saveId(${id})' href="post.html">User post</a>
				<a class='user_btn-album' onclick='saveId(${id})' href="album.html">User album</a>
				<a class='user_btn-photos' onclick='saveId(${id})' href="photos.html">User photos</a>
			</div>
		</div>
  `
}
